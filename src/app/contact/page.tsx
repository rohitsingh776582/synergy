            ...
            <Container>
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-5 space-y-8">
                  <div>
                    <h3 className="text-2xl font-normal text-gray-900">Head Office</h3>
                    <div className="mt-4 flex items-start gap-4 p-5 rounded-none bg-white border border-gray-200">
                      ...
                      <div className="text-sm font-light">
                        <span className="font-medium text-gray-900 block text-base mb-1">New Delhi Office</span>
                  ...
                  <div>
                    <h3 className="text-2xl font-normal text-gray-900">Factory & Works</h3>
                    <div className="mt-4 flex items-start gap-4 p-5 rounded-none bg-white border border-gray-200">
                      <div className="p-3 rounded-none bg-purple-100 text-[#5b176e] shrink-0">
                        <Factory className="w-6 h-6" />
                      </div>
                      <div className="text-sm font-light">
                        <span className="font-medium text-gray-900 block text-base mb-1">Gurugram Manufacturing Plant</span>
                  ...
                  <div className="p-6 rounded-none bg-gradient-to-br from-[#5b176e] to-[#461056] text-white space-y-4">
                    <h4 className="text-lg font-normal">Direct Channels</h4>
                  ...
                  <div className="rounded-none bg-gray-200 h-48 w-full flex items-center justify-center text-gray-500 font-light text-sm border border-gray-300">
                ...
                <div className="lg:col-span-7">
                  <div className="bg-white p-8 md:p-10 rounded-none border border-gray-200">
                    <h3 className="text-2xl font-normal text-gray-900 mb-6">Send Us a Direct Message</h3>
                    <ContactForm />
                  </div>
                </div>
