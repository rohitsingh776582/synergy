        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Link
                href="/quote"
                className="inline-flex items-center justify-between gap-4 bg-[#511663] hover:bg-[#3d0f4b] text-white px-6 py-3.5 text-xs sm:text-sm font-light shadow-sm transition-colors"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-between gap-4 bg-[#ad96b6] hover:bg-[#9980a3] text-white px-6 py-3.5 text-xs sm:text-sm font-light shadow-sm transition-colors"
              >
