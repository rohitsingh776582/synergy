        ...
        <Container>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap md:flex-nowrap justify-between items-start gap-6 lg:gap-8 pb-16">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs sm:text-sm font-medium text-gray-600">
                <li>
                  <Link href="/products" className="hover:text-[#5b176e] transition-colors">
                    All Panels
                  </Link>
                </li>
                <li>
                  <Link href="/applications" className="hover:text-[#5b176e] transition-colors">
                    Applications
                  </Link>
                </li>
                <li>
                  <Link href="/projects" className="hover:text-[#5b176e] transition-colors">
                    Case Studies
                  </Link>
                </li>
                <li>
                  <Link href="/blogs" className="hover:text-[#5b176e] transition-colors">
                    Technical Blog
                  </Link>
                </li>
              </ul>
