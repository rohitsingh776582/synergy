...
import { Star, ShieldCheck, Sparkles, Building2, User } from "lucide-react";
...
const leftColumnCards: Testimonial[] = [
  {
    id: "left-1",
    quote: "Synergy's continuous lamination line delivered 18,000 m² of PIR panels within 10 days. Zero site delay and exceptional panel flatness.",
    author: "Priya Nair",
  ...
  {
    id: "left-2",
    quote: "Implementing Synergy PUF panels was seamless. The precision tongue-and-groove joint system made on-site installation effortless.",
    author: "Rajesh Patel",
...
const centerColumnCards: Testimonial[] = [
  {
    id: "center-1",
    quote: "Their robust thermal insulation and quick technical support made our pharma cleanroom project significantly more efficient.",
  ...
  {
    id: "center-2",
    quote: "The high-density PUF panels boosted thermal efficiency and reduced refrigeration power costs by over 28% across our warehouse.",
...
const rightColumnCards: Testimonial[] = [
  {
    id: "right-1",
    quote: "Our cold storage warehouse operations improved drastically with airtight cam-lock insulation and reliable temperature retention.",
    author: "Rahul Saxena",
  ...
  {
    id: "right-2",
    quote: "They delivered high-spec sandwich panels that exceeded our structural and thermal compliance requirements perfectly on time.",
                ...
                {leftItems.map((item, idx) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3.5">
                      <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-gray-100 border border-gray-200 text-gray-500">
