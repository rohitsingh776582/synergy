...
export default function ApplicationsHeroAnimationss() {
    ...
    return (
        <section className="relative w-full min-h-[600px] bg-[#F7F7F9] text-gray-900 overflow-hidden font-sans select-none">
            ...
            {stage >= 3 && (
                <Container className="relative w-full h-full z-30 flex flex-col justify-between py-6 sm:py-8 lg:py-10">
                    ...
                    <div className="my-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full pt-2 pb-4">
                        ...
                        <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
                            ...
                            <motion.p
                                ...
                                className="text-sm sm:text-base md:text-lg text-gray-600 font-light leading-relaxed max-w-lg antialiased"
                            >
