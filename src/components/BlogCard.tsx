    ...
    <div className="group flex flex-col justify-between overflow-hidden rounded-3xl bg-white border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300">
      <div>
        <div data-scale-up className="relative aspect-[16/10] w-full overflow-hidden bg-gray-900">
          ...
          />
          <span className="absolute top-4 left-4 rounded-full bg-[#5b176e] px-3.5 py-1 text-[11px] font-semibold tracking-[0.18em] uppercase text-white">
            {blog.category}
          </span>
        </div>

        <div className="p-6">
          <div className="flex items-center gap-4 text-xs font-light text-gray-500 mb-2">
          ...
          <h3 className="text-lg font-normal text-gray-900 group-hover:text-[#5b176e] transition-colors leading-snug">
            {blog.title}
          </h3>
